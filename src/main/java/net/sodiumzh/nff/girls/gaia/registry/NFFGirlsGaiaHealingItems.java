...
public class NFFGirlsGaiaHealingItems {
    ...
    public static NFURegistry.Accessor<MobApplicableItemTable> AQUATIC =
        COLLECTION.register("healing_aquatic", () -> MobApplicableItemTable.builder()
            .readData(new ResourceLocation(NFFGirlsGaia.MOD_ID, "healing_items/aquatic.json"), NFFGirlsDataReaders::readMobApplicableItemTable)
            .build());
